...
- (void)configImages
{
    ...
    [self.preImageView sd_setImageWithURL:[NSURL URLWithString:self.images[preIndex]] placeholderImage:[UIImage imageNamed:@"1"]];
    [self.currentImageView sd_setImageWithURL:[NSURL URLWithString:self.images[_currentIndex]] placeholderImage:[UIImage imageNamed:@"1"]];
    [self.nextImageView sd_setImageWithURL:[NSURL URLWithString:self.images[nextIndex]] placeholderImage:[UIImage imageNamed:@"1"]];
